...
This is a really silly, entirely unnecessary, but fun Foundry VTT module called **Idle Token Animation**. It adds subtle ambient motion to living tokens, making them gently bob, sway, and tilt while remaining in their true scene position. The idea began as a macro for [FX Bus](https://github.com/SamF111/fxbus/), but it gradually became substantial enough to turn into its own standalone module.
